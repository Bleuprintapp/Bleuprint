...
- Booking uses `https://calendly.com/kalenagardner07/30min`.
- Diagnosis, consultation, and review form submissions are sent through FormSubmit to the Bleuprint inbox configured in the source.
