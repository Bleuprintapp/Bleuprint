...
export async function GET() {
  ...
  return NextResponse.json({
    connectors: [
      { id: "microsoft", name: "Microsoft 365", state: process.env.MICROSOFT_CLIENT_ID && process.env.MICROSOFT_CLIENT_SECRET && process.env.MICROSOFT_TENANT_ID ? "ready-to-authorize" : "needs-app-credentials", mode: "OneDrive files + Microsoft Lists CRM + Outlook email" },
